...
class AMISegmentationDataModule(pl.LightningDataModule):
    def __init__(self, audio_dir, train_rttm_dir, val_rttm_dir,
                 window_size=6.0, window_hop=1.0, max_speakers=4,
                 batch_size=32, num_workers=11):
        super().__init__()
...
if __name__ == "__main__":
    ...
    data_module = AMISegmentationDataModule(audio_dir=AUDIO_DIR, train_rttm_dir=TRAIN_RTTM_DIR,
